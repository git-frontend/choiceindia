...
//console.log("CIQ.Market",CIQ.Market)
...
CIQ.Market.Symbology.factory = function (symbolObject) {
	...
	var symbol = symbolObject.symbol;
		console.log("symbolObject",CIQ.Market[symbolObject.ExchangeSegment])
		return CIQ.Market[symbolObject.ExchangeSegment] || CIQ.Market.NSE;
};
/**
