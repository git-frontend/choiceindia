...
// import * as forecastQuoteFeed from '../examples/feeds/quoteFeedForecastSimulator.js'
//  import tfcDemo from "../../../app/tools-module/components/tfc-demo.ts";
//  import marker from "../examples/markers/markersSample.js"
	...
	function getConfig(resources = {}) {
		...
		console.log(resources,"resourcesresources",CIQ.Market.Symbology.factory)
		let config = {
			// Symbol can be string or
			// or an object containing property symbol of string type along with other properties
			initialSymbol: {
				symbol: resources.params?resources.params.SecName:'',
				SegmentId:resources.params?resources.params.segmentId:'',
				Token:resources.params?resources.params.token:'',
				exchDisp:resources.params?resources.params.SecDesc:'',
			},
		...
		marketFactory: 	function (symbolObject) {
				let Config={ 
					NSE : {
					name: "NSE",
					...
					rules: [
						{ date: "2024-01-22", open: "00:00", close: "00:00" },
						{ date: "2024-01-26", open: "00:00", close: "00:00" },
						{ date: "2024-03-08", open: "00:00", close: "00:00" },
						{ date: "2024-03-25", open: "00:00", close: "00:00" },
						{ date: "2024-03-29", open: "00:00", close: "00:00" },
						{ date: "2024-04-11", open: "00:00", close: "00:00" },
						{ date: "2024-04-17", open: "00:00", close: "00:00" },
						{ date: "2024-05-01", open: "00:00", close: "00:00" },
						{ date: "2024-06-17", open: "00:00", close: "00:00" },
						{ date: "2024-07-17", open: "00:00", close: "00:00" },
						{ date: "2024-08-15", open: "00:00", close: "00:00" },
						{ date: "2024-10-02", open: "00:00", close: "00:00" },
						{ date: "2024-11-01", open: "00:00", close: "00:00" },
						{ date: "2024-11-15", open: "00:00", close: "00:00" },
						{ date: "2024-12-25", open: "00:00", close: "00:00" },
						{
							"date": "2024-01-20",
							"open": "09:15",
							"close": "16:00"
				...
				MCX : {
					...
					hour_aligned: false,
					rules: [
							{ date: "2024-01-01", open: "09:00", close: "17:00" },
							{ date: "2024-01-26", open: "00:00", close: "00:00" },
							{ date: "2024-03-08", open: "17:00", close: "23:55" },
							{ date: "2024-03-25",  open: "17:00", close: "23:55" },
							{ date: "2024-03-29", open: "00:00", close: "00:00" },
							{ date: "2024-04-11", open: "17:00", close: "23:55" },
							{ date: "2024-04-17", open: "17:00", close: "23:55" },
							{ date: "2024-05-01", open: "17:00", close: "23:55"},
							{ date: "2024-06-17",  open: "17:00", close: "23:55" },
							{ date: "2024-07-17",  open: "17:00", close: "23:55" },
							{ date: "2024-08-15", open: "00:00", close: "00:00" },
							{ date: "2024-10-02", open: "00:00", close: "00:00" },
							{ date: "2024-11-01",open: "17:00", close: "23:55"  },
							{ date: "2024-11-15",  open: "17:00", close: "23:55" },
							{ date: "2024-12-25", open: "00:00", close: "00:00" },
						...
						{ date: "2024-01-22", open: "17:00", close: "23:45" }
					]
				},
				NCDEX :{
					name: "MCX",
				...
				CIQ.Market.Symbology = CIQ.Market.Symbology || function () {};
					...
					console.log("symbolObject22222",Config[symbolObject.ExchangeSegment])
					return Config[symbolObject.ExchangeSegment] || CIQ.Market.NSE;
			},
			...
			quoteFeeds: [
				{
					...
					behavior: { refreshInterval: 0.3, bufferSize: 200 },
					// filter: () => {}
				}
			],
			selector: {
			...
			menuPeriodicity: [
				...
				{ type: "item", label: "3 Min", cmd: "Layout.setPeriodicity(1,3,'minute')", value: { period: 1, interval: 3, timeUnit: 'minute' } },
			...
			plugins: {
				...
				tfc: {
					moduleName: "TFC",
					 // Account instance object or a constructor
					/**
...
const params = paramsToObject(entries);
				config.symbolObject={symbol: params?params.SecName:'',
				SegmentId:params?params.segmentId:'',
				Token:params?params.token:'',
				exchDisp:params?params.SecDesc:''}


			//	console.log("onChartReady createChart",config,location.search)
