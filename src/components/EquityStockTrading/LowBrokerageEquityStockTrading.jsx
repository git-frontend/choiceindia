...
function LowBrokerageEquityStockTrading() {
                                    ...
                                    <Slider {...settings} id="advslider">
                                        ...
                                        <div className="col-md-4 item p-md-2" data-toggle="modal" data-target="#myModal1">
                                            <div className="card adv-card">
                                                ...
                                                <LazyLoader src={Image7} className={'img-fluid'} width={"83"} height={"83"} alt={"Equity Brokerage Charges to Open Trading Account Online"} />
                                                </div>
                                        ...
                                        <div className="col-md-4 item  p-md-2" data-toggle="modal" data-target="#myModal2">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                <LazyLoader src={Image9} className={'img-fluid lazyload'} width={"83"} height={"64"} alt={"Commodity Charges for Opening Equity Trading Account"} />
                                                </div>
                                                <div className="card-block">
                                        ...
                                        <div className="col-md-4 item p-md-2" data-toggle="modal" data-target="#myModal5">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                <LazyLoader src={Image8} className={'img-fluid lazyload'} width={"84"} height={"83"} alt={"Currency Brokerage to Open Equity Trading"} />
                                                </div>
                                                <div className="card-block">
...
export default LowBrokerageEquityStockTrading;
