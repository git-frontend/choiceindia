...
Note: Investica is a part of Choice Wealth Pvt ltd and registered under the ARN Code: 78908
                                ...
                                <Accordion.Header as="h3" className='faq-header'>What is the process for mutual fund agent registration?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                view ?
                                    <Accordion defaultActiveKey="5" flush className='open-demat-faqs-accordion'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>When will I get the commission of the investment?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="7" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>What is the minimum &amp; maximum age to apply for ARN?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>Why is ARN code necessary? </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
