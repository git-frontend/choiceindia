                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>Is it necessary to clear the NISM exam to become a mutual fund distributor in India?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>What are the career prospects of being a mutual fund distributor?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>What is the process for senior citizens to become a mutual fund distributor?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>How to become a mutual fund distributor?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="4" className='faq-item' id="Faqid">
                                    <Accordion.Header as="h3" className='faq-header'>In what form do mutual fund distributors earn revenue?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                view ?
                                    <Accordion defaultActiveKey="5" flush className='open-demat-faqs-accordion'>
                                        <Accordion.Item eventKey="5" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'> Is the mutual fund distribution business profitable?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>With which agency are mutual fund distributors registered?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="7" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>How much does a mutual fund distributor earn?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>When will I get the commission on the investment? </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="9" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>What is the minimum and maximum age to apply for ARN?
                                            </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="10" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>Why is the ARN Code Necessary?
                                            </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
