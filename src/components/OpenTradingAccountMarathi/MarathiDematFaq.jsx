                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header> <h4 className='faq-header'>डिमॅट खाते सक्रिय होण्यासाठी किती वेळ लागेल?</h4></Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header> <h4 className='faq-header'>डिमॅट खाते उघडण्यासाठी कोणती कागदपत्रे आवश्यक आहेत?</h4></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header><h4 className='faq-header'> पॉवर ऑफ अँटर्नी म्हणजे काय आणि त्याची गरज का आहे?</h4></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header><h4 className='faq-header'>मी पॉवर ऑफ अँटर्नी कोठे कुरिअर करावी?</h4> </Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="4" className='faq-item'>
                                    <Accordion.Header > <h4 className='faq-header'>चॉईस ब्रोकिंगसह डिमॅट खाते उघडण्यासाठी काही शुल्क आकारले जाते का?</h4></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                view ?
                                    <Accordion defaultActiveKey="" flush className='open-demat-faqs-accordion'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>मी दुसऱ्या एखाद्या डिमॅट खात्यातून माझ्या चॉईस ब्रोकिंगच्या डिमॅट खात्यात शेअर्स कसे हस्तांतरित करु शकतो?</h4> </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="9" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'> शेअर बाजारातील गुंतवणुकीसाठी डिमॅट खाते उघडणे आवश्यक आहे का?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="10" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'>मी माझे जुने डिमॅट खाते चॉईससह वापरू शकतो का?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="11" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>मी डिमॅट खात्यात पैसे ठेवू शकतो का?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="12" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>ऑनलाईन डिमॅट खाते उघडणे सुरक्षित आहे का?</h4> </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="13" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'>ट्रेडिंग खात्यातून पैसे जमा करणे आणि काढणे यासाठी मर्यादा आहेत का?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="14" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'>मी स्टॉक, चलन, डेरिव्हेटिव्ह आणि कमोडिटी ट्रेडिंगसाठी समान डिमॅट किंवा ट्रेडिंग खाते वापरु शकतो का?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="15" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>चॉईसद्वारे डिमॅट खाते उघडण्याचे किती शूल्क आकारले जाते?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="16" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>ऑनलाईन डिमॅट आणि ट्रेडिंग खाते उघडण्यासाठी पात्रता आणि निकष काय आहेत?</h4> </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
...
<br />
                                        ...
                                        <Accordion.Item eventKey="18" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'>पेपरलेस डिमॅट खाते उघडणे म्हणजे काय?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
