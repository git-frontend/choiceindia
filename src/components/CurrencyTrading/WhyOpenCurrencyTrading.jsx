                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <div className="sectext">
                                <h2>Perks Opening a Currency Trading Account Online With Us?</h2>
                            </div>
                        </div>
                                ...
                                <Slider {...settings} id="advslider" className="adv-sect-slider">
                                    <div className="card adv-card">
                                        <div className="icon-wrap">
                                            <LazyLoader src={Image7} className={"img-fluid"} width={"40"} height={"41"} alt={"Open Currency Trading Account with Low Brokerage Charges"} />
                                    ...
                                    <div className="card adv-card">
                                        <div className="icon-wrap">
                                            <LazyLoader src={Image8} className={"img-fluid lazyload"} width={"40"} height={"41"} alt={"Currency Trading Account In India with free Call for trade facility"} />
                                    ...
                                    <div className="card adv-card">
                                        <div className="icon-wrap">
                                            <LazyLoader src={Image9} width={"40"} height={"41"} alt={"Open Paperless Currency Trading Account"} className={"img-fluid lazyload"} />
                                    ...
                                    <div className="card adv-card">
                                        <div className="icon-wrap">
                                            <img src={Image10} width={"50"} height={"50"} alt={"Open Best Currency Trading Account with Advance Trading Platform"} className={"img-fluid lazyload"} />
                                    ...
                                    <div className="card adv-card">
                                        <div className="icon-wrap">
                                            <img src={Image11} width={"40"} height={"41"} alt={"Open Free Currency Trading Account and earn more from referrals"} className={"img-fluid lazyload"} />
