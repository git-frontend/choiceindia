                        ...
                        <div className='col-md-12'>
                            <div className="wrap">
                                <div className="leftsect">
                                    <h2 className="secttile">Trade forex with best broker in India</h2>
                                    <div className="img">
                                        <img src={Image16} alt={"Why Open Currency Trading Account with Choice"} width={"365"} height={"788"} className="img-fluid" />
                                    </div>
                                </div>
                                <div className="rightsect">
                                    <div className="rightsect-sub">
                                        <p className="headtxt">RESEARCH &amp;<br /> ADVISORY SERVICES</p>
                                        <p className="subtxt">A dedicated research team that provides Technical and Fundamental Research on the currency market at no extra cost</p>
                                    </div>
                                    <hr></hr>
                                    <div className="rightsect-sub">
...
export default WhyCurrencyTrading;
