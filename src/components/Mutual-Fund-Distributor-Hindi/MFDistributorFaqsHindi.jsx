                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>क्या भारत में म्यूचुअल फंड सलाहकार बनने के लिए NISM परीक्षा पास करना जरूरी है?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड एडवाइजर बनने के लिए करियर की क्या संभावनाएं हैं?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>वरिष्ठ नागरिकों के लिए म्यूचुअल फंड वितरक बनने की प्रक्रिया क्या है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड वितरक कैसे बनें? </Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड एजेंट पंजीकरण की प्रक्रिया क्या है?
</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                view ?
                                    <Accordion defaultActiveKey="5" flush className='open-demat-faqs-accordion'>
                                        <Accordion.Item eventKey="5" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड वितरक कितना कमाता है?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>मुझे निवेश का कमीशन कब मिलेगा?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="7" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>ARN के लिए आवेदन करने की न्यूनतम और अधिकतम आयु क्या है?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>ARN कोड क्यों जरूरी है?
 </Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
