                                ...
                                <div className="col-md-12">
                                    <Slider {...settings} id="advslider" className="">
                                        ...
                                        <div className="col-md-4 item p-md-2" data-toggle="modal" data-target="#myModal1">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                    <img src={Image7}  width={"83"} height={"83"} className="img-fluid" alt={"ट्रेडिंग खाते उघडण्यासाठी इक्विटी ब्रोकरेज शुल्क"} />
                                                </div>
                                        ...
                                        <div className="col-md-4 item  p-md-2" data-toggle="modal" data-target="#myModal2">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                    <img src={Image8}  width={"84"} height={"83"} alt={"ट्रेडिंग खाते उघडण्यासाठी मुद्रा ब्रोकरेज शुल्क"} className="img-fluid lazyload" />
                                                </div>
                                                <div className="card-block">
                                        ...
                                        <div className="col-md-4 item p-md-2" data-toggle="modal" data-target="#myModal5">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                    <img src={Image9}  width={"83"} height={"64"} alt={"ऑनलाइन ट्रेडिंग खात्यावर कमोडिटी ब्रोकरेज शुल्क"} className="img-fluid lazyload" />
                                                </div>
                                                <div className="card-block">
