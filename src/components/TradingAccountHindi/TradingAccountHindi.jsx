                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <div className="para">
                                ...
                                <span className="font-bold">ट्रेडिंग अकाउंट -</span>
                                ट्रेडिंग अकाउंट   ट्रेडर के लिए इंट्राडे ट्रेडिंग या कम समय में लेनदेन के लिए उपयुक्त है। <br /><br /> <br /> 
                                ...
                                एएमसी शुल्क लागू नहीं होते हैं लेकिन निवेशक को ब्रोकरेज और वैधानिक शुल्क जैसे जीएसटी, एसटीटी, टर्नओवर टैक्स, स्टांप ड्यूटी और एक्सचेंज शुल्क का भुगतान करना पड़ता है। <br /><br />
