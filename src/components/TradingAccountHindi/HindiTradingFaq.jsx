                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'> ऑनलाइन ट्रेडिंग खाता खोलने के लिए कितना समय लगता है?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>क्या ऑनलाइन ट्रेडिंग अकाउंट खोलते समय स्टॉक ब्रोकरों द्वारा कोई शुल्क लगाया जाता है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>चॉइस ट्रेडिंग अकाउंट के लिए एएमसी शुल्क क्या हैं</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>ऑनलाइन ट्रेडिंग अकाउंट खोलने के लिए किन दस्तावेजों की आवश्यकता होती है? </Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Header as="h3" className='faq-header'> क्या ट्रेडिंग खाता खोलते समय पावर ऑफ अटॉर्नी (पीओए) प्रदान करना आवश्यक है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>मैं अपने ट्रेडिंग खाते में कितना पैसा रख सकता हूं?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
