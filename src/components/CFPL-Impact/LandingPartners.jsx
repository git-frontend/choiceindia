...
import StateBank from '../../assets/images/cfpl-impact/state-bank-of-india.svg';
import SBMBank from '../../assets/images/cfpl-impact/sbm-bank-india.svg';
              ...
              <Slider {...settings1} className="why-ch-slider">
                  <div className="carditem-cfpl">
                    <span className='cardimg'>
                      <LazyLoader src={StateBank} alt={"State Bank of India"} className={"img-fluid img"} width={"90"} height={"90"} />
                    </span>
                    <h6 className="card-ttl">State Bank of <br/> India</h6>
                  </div>
                  <div className="carditem-cfpl">
                    <span className='cardimg'>
                      <LazyLoader src={SBMBank} alt={"SBM Bank India"} className={"img-fluid img"} width={"90"} height={"90"} />
                    </span>
                    <h6 className="card-ttl">SBM Bank <br/> India</h6>
                  </div>
                  <div className="carditem-cfpl">
                    <span className='cardimg'>
                      <LazyLoader src={AUSmallFinance} alt={"AU Small Finance Bank"} className={"img-fluid img"} width={"90"} height={"90"} />
                    </span>
                    <h6 className="card-ttl">AU Small Finance <br/> Bank</h6>
                  </div>
                  <div className="carditem-cfpl">
                    <span className='cardimg'>
                      <LazyLoader src={BajajFinance} alt={"Bajaj Finance"} className={"img-fluid img"} width={"90"} height={"90"} />
                    </span>
