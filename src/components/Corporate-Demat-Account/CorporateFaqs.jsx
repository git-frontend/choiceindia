                        ...
                        <div className="col-xl-11 col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    ...
                                    <ul>
                                    <li><strong>Ownership:</strong>A corporate demat account is owned and operated by a company or legal entity, whereas an individual demat account belongs to a single person.</li><br/>
                                    <li><strong>Purpose:</strong>Corporate demat accounts cater to business operations, investments, and corporate transactions, while individual accounts are for personal investment and trading activities.</li><br/>
                                    <li><strong>Documentation:</strong>Opening a corporate demat account requires additional documentation, such as company registration documents, board resolutions, and authorised signatory details.</li><br/>
                                    <li><strong>Compliance:</strong>Corporate demat accounts are subject to stricter compliance requirements, including KYC norms, anti-money laundering regulations, and corporate governance guidelines.</li><br/>
                                    <li><strong>Operation, accessibility, and management:</strong>Multiple authorised representatives from the company can access and operate a corporate demat account, while an individual account is solely managed by the account holder.</li><br/>
                                    <li><strong>Fees and Charges:</strong>Corporate demat accounts often have different fee structures catering to higher trading volumes and transaction values.</li><br/>
                                    <li><strong>Transaction Limits:</strong> Corporate demat accounts may have higher or no transaction limits, depending on the company's requirements and broker's policies.</li><br/>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    ...
                                    <ul type="none">
                                        <li><strong>1.&nbsp;&nbsp;Efficient and Streamlined Management of Your Company's Securities Portfolio:</strong><br/>
                                        Companies can effectively manage investments, securities holdings, and corporate actions through a consolidated platform.</li><br/>
                                        <li><strong>2.&nbsp;&nbsp;Enhanced Liquidity and Access to Capital Markets:</strong><br/>
                                        Dematerialised securities can be easily traded, providing improved liquidity and access to capital markets.</li><br/>
                                        <li><strong>3.&nbsp;&nbsp;Reduced Paperwork and Administrative Costs:</strong><br/>
                                        By eliminating physical certificates, companies significantly reduce costs associated with issuing, transferring, and maintaining paper-based records.</li><br/>
                                        <li><strong>4.&nbsp;&nbsp;Improved Recordkeeping and Audit Trail:</strong><br/>
                                        Corporate demat accounts maintain a transparent and auditable trail of all transactions, facilitating better recordkeeping, auditing, and compliance.</li><br />
                                        <li><strong>5.&nbsp;&nbsp;Seamless Execution of Corporate Actions:</strong><br/>
                                        Corporate demat accounts simplify the execution of actions like stock splits, mergers, acquisitions, and dividend distributions, ensuring timely processing.</li><br/>
                                        <li><strong>6.&nbsp;&nbsp;Access to Advanced Trading Platforms:</strong><br/>
                                        Companies can leverage brokers' advanced trading platforms and tools, enabling efficient trade execution and portfolio management.</li><br/>
                                        <li><strong>7.&nbsp;&nbsp;Dedicated Relationship Management:</strong><br/>
                                        Many brokers offer specialised services and dedicated relationship managers tailored to corporate clients' unique needs.</li><br/>
                                        <li><strong>8.&nbsp;&nbsp;Comprehensive Reporting and Analytics:</strong><br/>
                                ...
                                <Accordion.Item eventKey="4" className='faq-item'>
                                    ...
                                    <ul type="none">
                                    <li><strong>1.&nbsp;&nbsp;Long-Term Capital Gains Tax Benefits:</strong><br/>
                                    ...
                                    <br/>
                                    <li><strong>2.&nbsp;&nbsp;Tax-Efficient Portfolio Management: </strong><br/>
                                    Holding securities in a demat account makes it easier to track investments, calculate, and report capital gains and losses for tax purposes.</li><br/>
                                    <li><strong>3.&nbsp;&nbsp;Dividend Tax Efficiency: </strong><br/>
                                    Companies can receive dividends directly into their demat accounts, streamlining tax reporting and compliance.</li><br/>
                                    <li><strong>4.&nbsp;&nbsp;Compliance with Regulatory Requirements:</strong><br/>
                                    Maintaining a corporate demat account demonstrates compliance with regulatory norms, potentially avoiding penalties or legal issues related to securities transactions.</li><br/>
                                    <li><strong>5.&nbsp;&nbsp;Potential Tax Deductions:</strong><br/>
                                ...
                                <Accordion.Item eventKey="5" className='faq-item'>
                                    ...
                                    <ul type="none">
                                        <li><strong>1.&nbsp;&nbsp;Dedicated Relationship Managers:</strong><br/>
                                        Choice provides dedicated relationship managers who offer personalised support and guidance, ensuring corporate clients' unique needs are addressed efficiently.</li><br/>
                                        <li><strong>2.&nbsp;&nbsp;Best-in-Class Trading Platforms:</strong><br/>
                                        Companies can access Choice's state-of-the-art trading platforms, featuring advanced tools, real-time market data, and advanced charting capabilities for informed decision-making.</li><br/>
                                        <li><strong>3.&nbsp;&nbsp;Comprehensive Reporting and Analytics:</strong><br/>
                                        Choice offers end-to-end reporting and analytical tools, enabling companies to monitor their portfolios, track performance, and generate customised reports for better investment management.</li><br/>
                                        <li><strong>4.&nbsp;&nbsp;Seamless Corporate Action Processing:</strong><br/>
                                        Choice simplifies the execution of corporate actions, such as stock splits, mergers, acquisitions, and dividend distributions, ensuring seamless and timely processing.</li><br />
                                        <li><strong>5.&nbsp;&nbsp;Integrated Banking Services: </strong><br/>
                                        Choice provides integrated banking services, allowing companies to seamlessly transfer funds and manage their investments from a single platform.</li><br/>
                                        <li><strong>6.&nbsp;&nbsp;Competitive Pricing and Brokerage Rates:</strong><br/>
                                        Choice offers competitive brokerage rates and pricing structures tailored specifically for corporate clients, considering their higher trading volumes and transaction values.</li><br/>
                                        <li><strong>7.&nbsp;&nbsp;Robust Security and Compliance:</strong><br/>
                                        Choice adheres to robust security protocols and compliance measures, ensuring the safety and integrity of corporate clients' transactions and data.</li><br/>
                                        <li><strong>8.&nbsp;&nbsp;Customisable Solutions:</strong><br/>
