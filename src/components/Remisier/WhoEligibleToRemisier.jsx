                        ...
                        <div className="col-md-6">
                            <div className="eligb-right-sec">
                                <Slider {...settings} className="slider-eligb">
                                    <div className="">
                                        <img src={ImageSub13} alt="Individual must be 18+ years old to become a remisier" className="img-fluid" width="74" height="74" />
                                        <h4>Individual must be 18+ years of age</h4>
                                    </div>
                                    <div className="">
                                        <img src={ImageSub14} alt="Become a remisier &amp; earn high commission " className="img-fluid" width="74" height="74" />
                                        <h4>A knack to sell products effortlessly</h4>
                                    </div>
                                    <div className="">
                                        <img src={ImageSub15} alt="Become a share market remisier &amp; start your own business" className="img-fluid" width="74" height="74" />
                                        <h4>A desire to be your own boss</h4>
                                    </div>
                                </Slider>
                                <div className="eligb-img-sec">
                                    <img src={ImageSub16} alt="Eligibility to become a remisier in stock market" className="img-fluid" width="384" height="384" />
                                </div>
                            </div>
                        </div>
                    </div>
