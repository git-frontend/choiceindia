                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-12 col-lg-8">
                            <div className="sell-more-list">
                                ...
                                <div className="more-list-item wow fadeInRight">
                                    <span>
                                        <img src={Bonds} alt="Become a remisier &amp; earn through Bonds"  className='img-fluid' width="45" height="45"/>
                                    </span>
                                    <h3 className="itm-ttl">Bonds</h3>
                                </div>
                                <div className="more-list-item wow fadeInRight">
                                    <span>
                                            <img src={CorporatePd} alt="Become a remisier &amp; earn through Corporate FDs" className='img-fluid' width="45" height="45" />
                                    </span>
