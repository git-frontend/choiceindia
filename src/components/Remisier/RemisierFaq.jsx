                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>Who can become a Choice Remisier?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>How much does a Remisier earn in India?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Header as="h3" className='faq-header'>What Are the Documents required to Become Choice Remisier?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
