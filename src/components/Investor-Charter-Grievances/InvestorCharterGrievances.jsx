...
function InvestorCharterGrievances() {
  ...
  function loadFileDownload() {
    cmsService.investorCharterData().
      then(
        res => {
            ...
            <div className="col-md-12">
              {
                toggleState == 1 ?
                  <div>
                    <h2 className="title text-center">Quarterly</h2>
                  ...
                  toggleState == 2 ?
                  <div>
                  <h2 className="title text-center">Monthly</h2>
                  <div className="quicklinkswrap">
...
export default InvestorCharterGrievances;
