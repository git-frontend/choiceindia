                        ...
                        <div className="col-md-8">
                            <div className="pl-4">
                                ...
                                <div className="card adv-card">
                                        ...
                                        <div className="card adv-card">
                                            <div className="icon-wrap">
                                      <img src={Image9} width={"48"} height={"36"} alt={"Refer and Earn Demat Account"} className="img-fluid lazyload" />
                                            </div>
                                            <div className="card-block">
                                        ...
                                        <div className="card adv-card">
                                            <div className="icon-wrap">
                                          <img src={Image11} width={"48"} height={"36"} alt={"Free Paperless Demat Account Opening"} className="img-fluid lazyload" />
                                            </div>
                                            <div className="card-block">

                                          <h5 className="card-title">Paperless Account Opening</h5>
                                                <p>
                                              Instantly open a paperless NRI demat account online within 5 minutes.
                                                </p>
                                            </div>
                                        </div>
                                </Slider>
