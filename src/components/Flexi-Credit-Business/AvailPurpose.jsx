                            ...
                            <div className="veh-bnr-list">
                                <div className="bnr-list-itm">
                                    <div className="bnr-list-right d-flex justify-content-end">
                                        <LazyLoader src={avail} alt={"Who Is Avail"} className={"img-fluid img"} width={"660"} height={"444"} />
                                    </div>
                                ...
                                <div className="bnr-list-itm">
                                    <div className="bnr-list-right">
                                        <LazyLoader src={Multitasking} alt={"Purpose"} className={"img-fluid img"} width={"539"} height={"539"} />
                                    </div>
                                    <div className="bnr-list-left">
