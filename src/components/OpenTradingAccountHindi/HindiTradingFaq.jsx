                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header> <h4 className='faq-header'>डीमैट खाता खोलने के लिए किन दस्तावेजों की आवश्यकता होती है?</h4></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header><h4 className='faq-header'>पावर ऑफ अटॉर्नी (पीओए) क्या है और इसकी आवश्यकता क्यों है?</h4></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header><h4 className='faq-header'>मुझे पावर ऑफ अटॉर्नी कहां कुरियर करना चाहिए?</h4> </Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                view ?
                                    <Accordion defaultActiveKey="" flush className='open-demat-faqs-accordion'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header> <h4 className='faq-header'>मैं दूसरे डीमैट खाते से शेयर अपने चॉइस डीमैट खाते में कैसे भेज सकता हूं?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="7" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>क्या शेयर बाजार में निवेश के लिए डीमैट अकाउंट खोलना आवश्यक है?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>क्या मैं चॉइस के साथ अपने पिछले डीमैट खाते का उपयोग कर सकता हूं?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                            ...
                                            <ol>
                                                <li>पता लगाएं कि कौन सा डीपी (डिपॉजिटरी पार्टिसिपेंट) शेयर धारण कर रहा है, भारत में 2 डिपॉजिटरी हैं, नेशनल सिक्योरिटीज डिपॉजिटरी लिमिटेड (एनएसडीएल) और सेंट्रल डिपॉजिटरी सर्विसेज लिमिटेड (सीडीएसएल) |</li>
                                        ...
                                        <Accordion.Item eventKey="9" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>क्या मैं डीमैट खाते में पैसा रख सकता हूँ?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="10" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>क्या ऑनलाइन डीमैट अकाउंट खोलना सुरक्षित है?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="11" className='faq-item'>
                                            <Accordion.Header><h4 className='faq-header'>क्या मैं स्टॉक, मुद्रा, डेरिवेटिव और कमोडिटी ट्रेडिंग के लिए उसी डीमैट या ट्रेडिंग खाते का उपयोग कर सकता हूं?</h4></Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
