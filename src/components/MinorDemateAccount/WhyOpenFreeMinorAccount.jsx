...
import Image9 from '../../assets/images/open-demat-account/refer-and-earn-demat-account.svg';
import Image10 from '../../assets/images/open-demat-account/advanced-trading-app-platform.svg';
import Image11 from '../../assets/images/open-demat-account/free-paperless-demat-account-opening.svg';
function WhyOpenFreeMinorAccount() {
                        ...
                        <div className="col-md-8">
                            <div className="pl-4">
                                ...
                                <div className="card adv-card">
                                        ...
                                        <div className="card adv-card">
                                            <div className="icon-wrap">
                                          <img src={Image9} width={"48"} height={"36"} alt="Earn More from Referrals" className="img-fluid lazyload" />
                                            </div>
                                            <div className="card-block">
                                        ...
                                        <div className="card adv-card">
                                            <div className="icon-wrap">
                                          <img src={Image11} width={"48"} height={"36"} alt="Paperless Account Opening" className="img-fluid lazyload" />
                                            </div>
                                            <div className="card-block">

                                          <h5 className="card-title">Paperless Account Opening</h5>
                                                <p>
                                                Instantly open a paperless Minor Demat Account online within 5 minutes
                                                </p>
                                            </div>
                                        </div>
                                </Slider>
...
export default WhyOpenFreeMinorAccount;
