...
function MinorDemateAccount() {
    ...
    return (
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <div className="para">
                                ...
                                <span className="read-more-wrap ">Can parents instill the value of investing and economic planning in their children at an early age? Surely they can do so by <Link to="/open-free-demat-account "><strong>opening free Demat Account</strong> </Link>for their Minor children.
        ...
        Opening a Minor Demat Account for your child can be the best investment and the most influential financial decision in your child’s life. The benefits of having a Minor Demat Account include: <br /><br />
          ...
          The process of a Minor Demat Account opening online is simple and convenient. The required documents include <br /><br />
          <li>Identification Proof</li>
          <li>Proof of Address</li>
          <li>A Photocopy for Age Verification</li>
          <li>A Photo of the Relevant Depository Member(s)</li><br />
          ...
          <h2 className="font-bold">Procedure To Open A Minor Demat Account </h2><br />
         ...
         2. The other KYC form for the Minor (to be filled and signed by the guardian)</li><br /><br />
         ...
         <li>Trading is not allowed via a Minor Demat Account.</li><br />
