...
const MinorDematOpeningProcess = () => {
    return (
        <div>
            ...
            <section className="open-acnt ">
                <div className="container">
                        ...
                        <div className="col-md-12">
                            <div className="get-started-sect ">
                                ...
                                <div className="headtext">
                                    <h3 className="mb-0">Open a <span>Paperless </span>  Minor Demat Account For Free</h3>
                                </div>

                                <div className="text-right text-sm-center">
                                    <Link to="/minor-demat-account" className="btn-bg btn-bg-dark " onClick={() => { utils.scrollToId('open-account-wrap') }} >Get Started </Link>
                                </div>
                    ...
                    <h2 className="sect-title">Minor Demat Account Opening Process</h2>
                        ...
                        <div className="col-sm-6 col-md-3 mt-lg-0 mt-5 mt-sm-2 mt-md-4 ">
                            <div className="demat-steps">
                                ...
                                <div className="info" >
                                    ...
                                    <p>Your Minor Demat Account opening is successful with Choice Broking.
                                    </p>
                                </div>
                            </div>
                        </div>
...
export default MinorDematOpeningProcess;
