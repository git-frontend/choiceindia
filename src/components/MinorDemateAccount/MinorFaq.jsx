                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>What is a Minor Demat Account?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>Can minors open demat accounts in India?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                        Yes, minors can have a demat account opened, but it will be operated by a guardian until the minor becomes a major.
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>What is the procedure to open a demat account for Minor?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>What are the documents required to open a Minor Demat account? </Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Header as="h3" className='faq-header'>Can minors operate Demat and Trading accounts?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                            ...
                            </Accordion>
                            {
                                view ?
                                    <Accordion defaultActiveKey="" flush className='open-demat-faqs-accordion'>
                                        ...
                                        <Accordion.Header as="h3" className='faq-header'>How to take ownership of Demat Account after minor turns major?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="6" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>How much time is required to open a demat account for minors?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="7" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>Who is eligible for opening a Minor Demat account in India?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="8" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>How to invest in the stock market when you’re less than 18 years old?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="9" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>Can we buy shares in the Minor Demat account?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="10" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>What are the restrictions on the Minor Demat account?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="11" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>What to do when a minor becomes a major?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
                                        ...
                                        <Accordion.Item eventKey="12" className='faq-item'>
                                            <Accordion.Header as="h3" className='faq-header'>Is any additional fee or charges applicable on the Minor Demat account?</Accordion.Header>
                                            <Accordion.Body className='open-demat-faq-body'>
