...
function LowBrokerageDerivativeTrading() {
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="text-center">
                                <h2 className="secttitle">Open a Low Brokerage Derivatives Trading Account</h2>
...
export default LowBrokerageDerivativeTrading;
