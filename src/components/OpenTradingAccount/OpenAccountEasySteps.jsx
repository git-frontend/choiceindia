                 ...
                 <div className='row'>
                    <div className="col-md-12">
                        <div className='text-center'>
                            <h2 className="title-first">How to Open  <span>Trading Account</span> in Easy Steps</h2>
                             <p>Know the comprehensive step-by-step account opening procedure by <a href="https://choiceindia.com/assets/downloads/Guidance-for-Online-Account-Opening.pdf" target="_blank">visiting this page.</a>
                            </p>
                        </div>
                    </div>
                    <div className='col-md-12'>
