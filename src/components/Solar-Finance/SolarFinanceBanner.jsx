                            ...
                            <Slider {...settings1} className="solar-banner-slider">
                                    <div className="carditem-nbfc">
                                        <span className='cardimg'>
                                            ...
                                            <img src={LoanSanction} alt="Zero Collateral for Channel Finnacing" className="img-fluid img"  width={"50"} height={"50"}></img> 
                                        </span>
                                    ...
                                    <div className="carditem-nbfc">
                                        <span className='cardimg'>
                                            ...
                                            <img src={GetLoan} alt="Full Feldge Channel Financing Assistance" className="img-fluid img"  width={"50"} height={"50"}></img> 
                                        </span>
                                    ...
                                    <div className="carditem-nbfc">
                                        <span className='cardimg'>
                                            ...
                                            <img src={Paperwork} alt="High Value Channel Financing" className="img-fluid img"  width={"50"} height={"50"}></img> 
                                        </span>
                                    ...
                                    <div className="carditem-nbfc">
                                        <span className='cardimg'>
                                            ...
                                            <img src={ProcessingFee} alt="Digital Channel Financing Documentation" className="img-fluid img"  width={"50"} height={"50"}></img> 
                                        </span>
