...
import icon1 from '../../assets/images/currency-trading-campaign/demat-account-with-daily-research-calls-from-experts.svg';
import icon2 from '../../assets/images/currency-trading-campaign/free-demat-account-with-advanced-trading-platform.svg';
import icon3 from '../../assets/images/currency-trading-campaign/demat-account-with-free-premium-research-tools.svg';
import Slider from 'react-slick';
import { Link } from "react-router-dom";
import LazyLoader from '../Common-features/LazyLoader';
import ResearchCalls from './ResearchCalls';
import CurrencyTradingNeeds from './CurrencyTradingNeeds';
import CurrencyTradingOpenDematAc from './CurrencyOpenDematAc';
import WhyChoice from './WhyChoice';
import './currency-trading.scss';

function CurrencyTradingCampaign() {
                    ...
                    <div className="container">
                        <div className="row ">
                            <div className="col-md-7 fandoleft">
                                <h1 className="big-ttl">Don’t Miss <span> Currency </span><br />Trading Opportunities!</h1>
                                <Slider {...settings1} className="carditem-option-tab">
                                    <div className="carditem-option">
                                        ...
                                        <h4 className="cardoption-ttl">Daily Currency Calls from Experts</h4>
                                    </div>
                                    <div className="carditem-option">
            ...
            </div>
            {
                isCheck ?
                    <div>
                        ...
                        <CurrencyTradingNeeds />
                        <CurrencyTradingOpenDematAc />
                        <WhyChoice />
                    </div>
                    : ""}
...
export default CurrencyTradingCampaign;