                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="sm-trader-des">
                                ...
                                <Link onClick={()=>scrollToId('dematform')}><span className="btn-bg btn-bg-dark">SAVE NOW <svg xmlns="http://www.w3.org/2000/svg" id="baseline-arrow_forward-24px" width="24" height="24" viewBox="0 0 24 24">
