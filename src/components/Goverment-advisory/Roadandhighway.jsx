  ...
  <div className="col-md-12">
    <div className="boxwrap">
      ...
      <div className="right-sec">
        <p className="text">bServed 1000+ ULBs ( 25% of Total Market ) in financial reforms, revenue reforms, process automation, scheme PMU, capacity building, DPR &amp; transaction advisory services. </p>
