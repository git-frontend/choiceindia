                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-md-12">
                            ...
                            <div className="imgblock">
                                <LazyLoader src={Bannerimage} className={"img-fluid"} alt={"Loading"} />
                    ...
                    <div className="row imgwrap">
                        <div className="col-md-6">
                            <div className="">
                                <LazyLoader src={twittertwo} className={"img-fluid"} alt={""} />
                                {/* <img src={twittertwo} className="img-fluid" /> */}
                            </div>
                        </div>
                        <div className="col-md-6">
                            <LazyLoader src={twitterone} className={"img-fluid"} alt={""} />
