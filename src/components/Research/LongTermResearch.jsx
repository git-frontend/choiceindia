          ...
          <div className="content-tabs">
            ...
            >
              <div className="research-tab-cont">
                            ...
                            <div className="res-tab-itm">
                              ...
                              <div className="tab-itm-des">
                                ...
                                <div className="itm-des-sub">
                                  ...
                                  {count === 4 ? <a onClick={() => { getSingleDetail(res.uuid) }} className="btn-sm grn-btn"> SUBSCRIBE</a> : count === 2 ? <a onClick={() => { getSingleDetail(res.uuid) }} className="btn-sm">HOLD</a> : <a onClick={() => { getSingleDetail(res.uuid) }} className="post-read">Read More</a>}
                            ...
                            <div className="res-tab-itm">
                              ...
                              <div className="tab-itm-des">
                                ...
                                <div className="itm-des-sub">
                                  <span className="date-post">03 Mar 2022</span>
                                  {/* <Link to={`/research-detailed/${res[i].uuid}`} className="post-read">Read More</Link> */}
                                  {count === 4 ? <a onClick={() => { getSingleDetail(res.uuid) }} className="btn-sm grn-btn"> SUBSCRIBE</a> : count === 2 ? <a onClick={() => { getSingleDetail(res.uuid) }} className="btn-sm btn-ptr">HOLD</a> : <a onClick={() => { getSingleDetail(res.uuid) }} className="post-read">Read More</a>}
                ...
                <div className="mt-5 d-flex justify-content-center"><a className="btn-bg btn-ptr" onClick={()=>{setCheck(true)}}>Load More</a></div>
              </div>
            </div>
          </div>
        </div>
