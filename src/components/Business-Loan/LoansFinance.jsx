            ...
            <div className="col-md-12">
              <div className="loans-finance-sec">
                <div className="head-sec">
                  ...
                  <p>We at Choice Finserv understand that being a business owner has certain challenges if funds are not sufficient for either meeting business requirements or for planning a{!show ? <span onClick={()=>{setshow(true)}}>... <em className="btn-read">Read more</em></span>:""}{show ?<span>&nbsp;business expansion. Business loans could be of great help in meeting capital requirements to ensure the smooth operations of business activities and help scale new heights of the growth opportunities. <br/>You require sufficient funds for your business to keep the operations alive and thus, require loans or credit facilities to help meet your capital demands. We are here to ensure that the lack of financing never stops your businesses from growing and expanding by giving you the financial push to make your business vision come true. <br/>We can help offer finances for your business in the form of a Term-Loan and Flexi-Credit.<span onClick={()=>{setshow(false)}}>&nbsp;<em className="btn-read">Read less</em></span></span>:""}</p>
                </div>
                ...
                <div className="fin-list-itm">
                  <div className="list-itm">
                    ...
                    <div className="itm-desc">
                      ...
                      <div className="para">
                      <p>It is a short-term loan against receivables of unpaid bills or invoices{!showinvoicefin ? <span onClick={()=>{setshowinvoicefin(true)}}>... <em className="btn-read">Read more</em></span>:""}{showinvoicefin ?<span>&nbsp;to anchor or spoke. When the seller supplies goods on credit and needs working capital for continuous production for fulfilling his future orders, at the same time buyers generally get more time to pay.
Choice is offering loans to the anchor's ecosystem against selling or purchasing invoices. Borrower as Anchor "or" spoke may be decided as per the deal structure and mutual agreement with one another.<span onClick={()=>{setshowinvoicefin(false)}}>&nbsp;<em className="btn-read">Read less</em></span></span>:""}</p>
                      </div>
                    </div>
                  </div>
                  <div className="list-itm">
                    ...
                    <div className="itm-desc">
                      ...
                      <div className="para">
                       <p>Working capital finance limit is generally extended to{!showchannelfin ? <span onClick={()=>{setshowchannelfin(true)}}>... <em className="btn-read">Read more</em></span>:""}{showchannelfin ?<span>&nbsp;selected “Spoke” on the recommendation of anchor, for the purpose of selling or buying of any goods, commodity, inventory or rendering of services for easy and smooth growth of their business.<span onClick={()=>{setshowchannelfin(false)}}>&nbsp;<em className="btn-read">Read less</em></span></span>:""}</p>
                      </div>
                    </div>
                  </div>
                </div>
