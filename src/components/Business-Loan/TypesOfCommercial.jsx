          ...
          <div className="row align-items-center justify-content-between">
            <div className="col-xl-5 col-md-6">
              <div className="fin-banner-caption">
                ...
                <p>Are you struggling for days and still unable to find a way to get your desired vehicle financed even after multiple attempts? Do{!show ? <span onClick={()=>{setshow(true)}}>... <em className="read-ext">Read more</em></span>:""}{show ?<span>&nbsp;not worry! <br/>
Your search can stop right here with us. We are a customer-oriented organization where we treat our customers like family. We at Choice Finserv offer affordable and budget-friendly vehicle loans making sure that the wheels of your growth keep moving.<span onClick={()=>{setshow(false)}}>&nbsp;<em className="read-ext">Read less</em></span></span>:""}</p>
