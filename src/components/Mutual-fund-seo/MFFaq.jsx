                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                ...
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>How much time does it take to start investing in Mutual Funds?</h3></Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>How does mutual fund investment work?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>When should I start investing in mutual funds?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>Does one need an account in a bank to invest in its mutual fund?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="4" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>What is the benefit of staying invested in the long term?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="5" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>How do I get my returns in mutual funds?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="6" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>Are any charges applicable for investing in mutual funds?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="7" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>What are the units in mutual funds?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="8" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>What is the Net Asset Value (NAV) of a scheme?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="9" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>What is the expense ratio on mutual fund schemes?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="10" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>What is the tax on mutual funds investment in India?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="11" className='faq-item'>
                                    <Accordion.Header> <h3 className='faq-header'>How to redeem mutual fund investment?</h3></Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
