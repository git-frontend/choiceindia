  ...
  <div className="row">
    ...
    <div className="col-md-11 col-md-offset-1">
      ...
      <span class="read-more-target"> This was possible only when in 1996 electronic trading was introduced to the market and since then a Demat account has been the mandatory part of anyone’s investing journey. So let’s now dig deeper into this and understand;<br /><br /><br />
          ...
          Now that we’ve explored what is a Demat account and how it helps us, let's further dive in and understand, how does a <a href="https://choiceindia.com/open-free-demat-account">Trading Account</a> play a role here? <br /><br />
          ...
          Now that we've understood how does a <a href="https://choiceindia.com/blog/difference-between-demat-and-trading-account/">Demat account and a trading account differ</a> from each other, let's look into the details; <br /><br />
          <div className="ml-3">
          ...
          <div className="ml-3">
            ...
            <ul>
              ...
              However, this<a href="https://choiceindia.com/minor-demat-account"> minor Demat account</a> needs to be operated under the guidance of the minor’s parent or guardian, meaning the minor himself cannot buy or sell shares.<br />
              Once the account holder is aged above 18 and wishes to take control of their Demat account, they can do so legally.<br />
              <li className="font-bold"><a href="https://choiceindia.com/nri-demat-account">NRI Demat Account</a></li>
              ...
              Demat accounts are not only limited to personal use, there are provisions for the corporate companies to invest as a single entity. <a href="https://choiceindia.com/corporate-demat-account">Corporate Demat accounts</a> are especially special because it reduces the paperwork significantly while you are buying, selling, trading and transferring securities.<br />
            </ul>
          </div><br />
          ...
          <ul>
            <li className="p1">First of all, you’d have to decide on your DP or Depository Participant, DP is an intermediate between you and your investments and DPs are usually banks, financial institutions and brokers.</li>
            <li className="p1">For choosing the appropriate DP you have to decide upon the brokerage charges and annual maintenance charges.</li>
            <li className="p1">You need to have a bank account and complete your KYC</li>
            <li className="">While completing your KYC you’ll have to attach copies of your;</li>
            <div className="ml-3 p1">
              1. PAN Card<br />
              2. ID Proof (eg; Aadhar)<br />
              3. Proof of Permanent Residence<br />
              4. Passport-size photographs
            </div>
            <li className="p1">While you submit your KYC along with all the copies of your necessary documents, you need to make sure you have the original documents with you as well for verification purposes. </li>
            <li className="p1">After the verification process, you are required to sign an agreement that lists out all the terms and conditions.</li>
            <li className="p1">Once your account is opened, your DP will be providing you with a unique client ID, this client ID will allow you to access your Demat account online.</li>
          </ul>
          ...
          While opening a Demat account you probably will be associated with various fees and charges, these are namely opening charge, safety charge, annual maintenance charge, transaction charges and Demat charges.
          ...
          <div className="ml-3">
            <li className="font-bold p1">Demat Charges</li>
            ...
            The annual Maintainance charge is also called the folio maintenance charge, these charges range between 200 - 1000 rupees per annum. The style at which <a href="https://choiceindia.com/blog/what-are-dp-charges/">DPs charge</a> AMC differs accordingly, some DPs charge their investors quarterly and some even take a lifetime fee, but charging investors annually is the most common way of collecting AMC.<br />
            ...
            DPs charge <a href="https://choiceindia.com/blog/dp-transaction-charges/">transactional charges</a> on both credit and debits, where every time you engaged in a trade a nominal amount is charged on your behalf for facilitating a smooth transaction between your Demat account and the market.<br />
          </div><br /><br />
          ...
          <ul>
            <li className="p1">Free AMC for a year and after a year the maintenance charge is at just 200 Rupees + GST, which is significantly lesser than the market standard.</li>
            <li className="p1">Free access to expert research and advisory, these reports provided have proven to have an impeccable accuracy record.</li>
            <li className="p1">Insanely low brokerage charges, Choice broking platform happens to be very trader friendly where call and trade orders have charges on them and squaring off your positions is also absolutely free. The Brokerage charges are as low as 2 paise.</li>
            <li className="p1"><a href="https://choiceindia.com/campaign/free-amc-demat-account">Open a Demat account with no amc,</a> Choice opens an account for you, free of cost.</li>
          </ul>
                    ...
                    <div className="para">
                      ...
                      <span className="read-more-wrap "> The stock market is an old establishment that has existed since 1875 when BSE 	was the first the first-ever stock market to be established in Asia, it is evident that in these 147 years of history a lot has changed and one among those changes was the transition of physical paper certificates shares to shares being traded on an online platform
                        ...
                        <span className="read-more-target"> This was possible only when in 1996 electronic trading was introduced to the market and since then a Demat account has been the mandatory part of anyone’s investing journey. So let’s now dig deeper into this and understand;<br /><br /><br />
                          ...
                          Now that we've understood how does a <Link to="/fablesdetail/difference-between-demat-and-trading-account">Demat account and a trading account differ</Link> from each other, let's look into the details; <br /><br />
                          <div className="ml-3">
                            <h3 className="font-bold"> 1. Delivery </h3>
                            A Demat account stores your stocks only when you take the delivery for it, you can further buy or sell in the future whereas your trading account facilitates you for your intraday activities, in intraday trading, you are required to sell off your positions by the end of the day, hence the intraday trades you’ve taken are not delivered to your Demat account.<br /><br />
                            <h3 className="font-bold"> 2. Bank Link</h3>
                          ...
                          <div className="ml-3">
                            ...
                            <li className="font-bold">Annual Maintainance Charge (AMC)</li>
                            Annual Maintainance charges are levied on the investor by the DP for the services they provide. <br />
                            The annual Maintainance charge is also called the folio maintenance charge, these charges range between 200 - 1000 rupees per annum. The style at which <Link to="/fablesdetail/what-are-dp-charges">DPs charge</Link> AMC differs accordingly, some DPs charge their investors quarterly and some even take a lifetime fee, but charging investors annually is the most common way of collecting AMC.<br />
                            <li className="font-bold">Transactional Charges</li>
                            The main aim of having a Demat account is participating in the Indian markets and while doing that it is evident that every transaction you make on the Demat account is a move towards your future.<br />
                            DPs charge <Link to="/fablesdetail/dp-transaction-charges">transactional charges</Link> on both credit and debits, where every time you engaged in a trade a nominal amount is charged on your behalf for facilitating a smooth transaction between your Demat account and the market.<br />
                          </div><br /><br />
                          <h3 className="font-bold">Why Should You Choose Choice to Open a Demat Account? </h3>
                          You’ve been through all the information that is out there about Demat and you hone enough knowledge to understand that picking a DP is no easy job, you’ll have to consider a lot of factors like charges and the services they provide and if that aligns with your conscience, you opt for them.<br />
                          But let us present ourselves and tell you why exactly you need to open a Demat account with Choice;<br />
