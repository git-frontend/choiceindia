          ...
          <div className="row">
            ...
            <div className="col-md-11 col-md-offset-1">
              <div className="para">
                ...
                <span id="dots1">....</span><span id="more1"><br /><br />
                  This was possible only when in 1996 electronic trading was introduced to the market and since then a Demat account has been the mandatory part of anyone’s investing journey. So let’s now dig deeper into this and understand;<br /><br /><br />
                ...
                </span><button className="readmorebtn" onClick="myFunction()" id="myBtn1">Read more</button>
              </div>
            </div>
          </div>
        </div>
