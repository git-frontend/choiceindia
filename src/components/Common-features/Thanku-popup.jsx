                ...
                <div className="thanku-overlay thanku-popup-active" >
                  <div className="thanku-popup">
                    <div className="sub-row">
                      ...
                      <div  className={((window.location.pathname.indexOf('sub-broker-franchise') > -1) || (window.location.pathname.indexOf('authorised-person') > -1) || (window.location.pathname.indexOf('remisier') > -1) || (isBlog=='blog')) ? "thanku sub-broker-success" :((!isShow.isOnboarding) && (window.location.pathname.indexOf('mutual-fund-distributor') > -1))? 'thanku mf-distributor-leads': ((isShow.isNewLead) && ((window.location.pathname.indexOf('sub-broker-franchise') == -1) && (window.location.pathname.indexOf('authorised-person') == -1) && (window.location.pathname.indexOf('remisier') == -1)))? (window.location.pathname.indexOf("/minor-demat-account") > -1)? 'minor-dl-success': (window.location.pathname.indexOf("/nri-demat-account") > -1)? 'nri-dl-success': (window.location.pathname.indexOf("/corporate-demat-account") > -1) ? 'corporate-dl-success': 'thanku campaign-success': "thanku "}>
                        <h1>Thank You !</h1>
                      </div>
