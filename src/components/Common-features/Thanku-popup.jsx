                ...
                <div className="thanku-overlay thanku-popup-active" >
                  <div className="thanku-popup">
                    <div className="sub-row">
                      ...
                      <div  className={((window.location.pathname.indexOf('sub-broker-franchise') > -1) || (window.location.pathname.indexOf('authorised-person') > -1) || (window.location.pathname.indexOf('remisier') > -1)) ? "thanku sub-broker-success" :(window.location.pathname.indexOf('mutual-funds-investment') > -1)?"thanku mutual_funds_leads":((!isShow.isOnboarding) && (window.location.pathname.indexOf('mutual-fund-distributor') > -1))? 'thanku mf-distributor-leads': ((!isShow.isOnboarding) && ((window.location.pathname.indexOf('sub-broker-franchise') == -1) && (window.location.pathname.indexOf('mutual-funds-investment') == -1) && (window.location.pathname.indexOf('authorised-person') == -1) && (window.location.pathname.indexOf('remisier') == -1)))?"thanku campaign-success":"thanku "}>
                        <h1>Thank You !</h1>
                      </div>
