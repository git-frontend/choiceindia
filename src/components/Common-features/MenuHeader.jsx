  ...
  */}                      </NavLink>
                    ...
                    onClick={ ()=>setShow(!show)} >
                        ...
                        <ul className="navbar-nav ms-auto nav-header">
                            ...
                            <li className="nav-item">
                                <NavLink to= '/online-trading-app' className={({isActive}) => "single-nav-links nav-link" + (isActive ? "single-nav-links nav-link active-header" :'')}>App</NavLink>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink to= '/research-listing-new'className={({isActive}) => "single-nav-links nav-link" + (isActive ? "single-nav-links nav-link active-header" :'')}>Research</NavLink>
                            </li>
                            {/* <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <NavLink to= '/contact-us' className={({isActive}) => "single-nav-links nav-link" + (isActive ? "single-nav-links nav-link active-header" :'')}>Contact</NavLink>
                            </li>
                            ...
                            <NavLink className="nav-link"  to='/open-free-demat-account'>Open Free Account</NavLink>
                            </li>
                        </ul>
                    </div>
                </div>
