                    ...
                    <div className="col-md-7">
                      <div className="quick-links-list">
                        ...
                        <ul className="reset">
                          ...
                          <li>
                            <Link to="/Investor-info" target="_blank">Investors</Link>
                          </li>
                          <li>
                    ...
                    <div className="col-md-7">
                      <div className="links-wrap-social">
                        <div className="wrap-app-links">
                          <a href="https://play.google.com/store/apps/details?id=com.choiceequitybroking.jiffy" target="_blank" className='link-nrl link-nrl-sm'>
