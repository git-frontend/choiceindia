      ...
      <div className={(check === 'show') ? " menu visible check-menu-main" : menu_class}>
        <div className="d-flex nbfc-info-menu-wrap">
          <ul className="nbfc-info-menu-list">
            ...
            <li className="menu-itm">
                <Link to="/emi-calculator" className="menu-itm-link"> 
            ...
            <li className="menu-itm">
              <Link to="/about-choice-finserv" className="menu-itm-link" >
            ...
            <li className="menu-itm">
              <Link to="/lending-partners" className="menu-itm-link" >
            ...
            <li className="menu-itm">
            <Link to="/cfpl-policies" className="menu-itm-link">
              <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg"></svg>
              <span className="menu_item_text">CFPL Policies & Disclosures</span></Link>
            </li>
          </ul>
        </div>
      </div>
