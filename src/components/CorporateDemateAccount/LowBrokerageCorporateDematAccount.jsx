...
function LowBrokerageCorporateDematAccount() {
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="text-center">
                                <h2 className="secttitle">Open a Low Brokerage Corporate Demat Account</h2>
                                <p>Brokerage is charged on a percentage basis for Intraday, Delivery and Futures while the brokerage for Options is calculated on the basis of a flat fee.
                                ...
                                <div className="col-md-12">
                                    <Slider {...settings} id="advslider" className="">
                                        ...
                                        <div className="col-md-4 item  p-md-2" data-toggle="modal" data-target="#myModal2">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                    <img src={Image8}  width={"84"} height={"83"} alt={"Currency Brokerage Charges"} className="img-fluid lazyload" />
                                                </div>
                                                <div className="card-block">
                                        ...
                                        <div className="col-md-4 item p-md-2" data-toggle="modal" data-target="#myModal5">
                                            <div className="card adv-card">
                                                <div className="icon-wrap">
                                                    <img src={Image9}  width={"83"} height={"64"} alt={"Commodity Brokerage Charges"} className="img-fluid lazyload" />
                                                </div>
                                                <div className="card-block">
...
export default LowBrokerageCorporateDematAccount;
