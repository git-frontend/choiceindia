...
import img1 from '../../assets/images/nbfc-loans/repayment-reminders.svg';
import img2 from '../../assets/images/nbfc-loans/easy-repayment-options.svg';
import img3 from '../../assets/images/nbfc-loans/check-soa.svg';
import img4 from '../../assets/images/nbfc-loans/documentation.svg';
import img5 from '../../assets/images/nbfc-loans/fast-loan-disbursal.svg';
import img6 from '../../assets/images/nbfc-loans/platform-access.svg';
                        ...
                        <div className="col-md-12">
                            <div className="loans-features-list">
                                <div className="loans-feat-itm">
                                    <span>
                                        <LazyLoader src={img1} alt={"Re-payment Reminders"} className={"img-fluid"} width={"60"} height={"60"} />
                                    </span>
                                ...
                                <div className="loans-feat-itm">
                                    <span>
                                        <LazyLoader src={img2} alt={"Easy Repayment Options"} className={"img-fluid"} width={"60"} height={"60"} />
                                    </span>
