                        ...
                        <div className="col-md-12">
                            <Accordion defaultActiveKey="0" flush className='open-demat-faqs-accordion'>
                                ...
                                <Accordion.Item eventKey="0" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड में निवेश शुरू करने में कितना समय लगता है?</Accordion.Header>
                                ...
                                <Accordion.Item eventKey="1" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड निवेश कैसे काम करता है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="2" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>मुझे म्यूचुअल फंड में निवेश कब शुरू करना चाहिए?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="3" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>क्या म्यूचुअल फंड में निवेश करने के लिए किसी बैंक में खाते की आवश्यकता होती है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="4" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>लंबी अवधि में निवेशित रहने का क्या फायदा है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="5" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>मैं म्यूचुअल फंड में अपना रिटर्न कैसे प्राप्त करूं?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="6" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>क्या म्यूचुअल फंड में निवेश के लिए कोई शुल्क लागू है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="7" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड में यूनिट क्या हैं?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="8" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>किसी योजना का शुद्ध संपत्ति मूल्य (NAV) क्या है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="9" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड योजनाओं पर व्यय अनुपात क्या है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="10" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>भारत में म्यूचुअल फंड निवेश पर क्या कर है?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
                                ...
                                <Accordion.Item eventKey="11" className='faq-item'>
                                    <Accordion.Header as="h3" className='faq-header'>म्यूचुअल फंड निवेश को कैसे भुनाएं?</Accordion.Header>
                                    <Accordion.Body className='open-demat-faq-body'>
