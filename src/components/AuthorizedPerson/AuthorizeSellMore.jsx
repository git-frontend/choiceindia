                        ...
                        <div className="col-md-12 col-lg-8">
                            <div className="sell-more-list">
                                <div className="more-list-item">
                                    <span>
                                        <img src={Commodity} alt="Authorised Person &amp; earn through Equity and Commodity Broking" className='img-fluid' width="45" height="45" />
                                    </span>
                                    <h3 className="itm-ttl">Equity, Commodity &amp; Currency Broking</h3>
                                </div>
                                <div className="more-list-item wow fadeInRight">
                                <span>
                                        <img src={MF} alt="Authorised Person &amp; earn through Mutual Funds" className='img-fluid' width="45" height="45" />
                                </span>
                                <h3 className="itm-ttl">Mutual Funds Distribution</h3>
                                </div>
                                <div className="more-list-item wow fadeInRight">
                                    <span>
                                        <img src={Insurance} alt="Authorised Person &amp; earn through Insurance"  className='img-fluid' width="45" height="45"/>
                                    </span>
                                    <h3 className="itm-ttl">Insurance</h3>
                                </div>
                                <div className="more-list-item wow fadeInRight">
                                <span>
                                        <img src={Retail} alt="Authorised Person &amp; earn through retail loans" className='img-fluid' width="45" height="45" />
                                </span>
