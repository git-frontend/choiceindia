      ...
      <Modal show={show} onHide={handleClose} size="lg" className='contest-modal-sub' aria-labelledby="contained-modal-title-vcenter" centered>
        ...
        <ul className="reset" id="style-scrll">
                <li>चालू माह में खोले गए सभी ट्रेडिंग खातों को उसी महीने के अंतिम कार्य दिवस तक ऑफ़र के लिए विचार किया जाएगा।</li>
                        <li>निवेश राशि जोड़ने और व्यापार / एसआईपी शुरू करने के लिए अगले महीने की 06 तारीख तक अनुग्रह अवधि प्रदान की जाती है।</li>
                        <li>योजना अवधि के दौरान एकत्र किए गए नकद (Cash) मार्जिन को प्रोत्साहन गणना के लिए माना जाएगा।</li>
                        <li>अगले महीने की 06 तारीख तक खाते में जोड़े गए कुल मार्जिन/एसआईपी पर ही अंतिम भुगतान गणना के लिए विचार किया जाएगा।</li>
                        ...
                        <li>अतिरिक्त पुरस्कारों के लिए, सक्रिय खाता न्यूनतम रु.500 इक्विटी निवेश के लिए और 2 ट्रेड, म्यूचुअल फंड SIP के लिए न्यूनतम रु.250|</li>
                    </ul>
        </Modal.Body>
      </Modal>
