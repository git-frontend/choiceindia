    ...
    return (
      ...
      <Modal show={show} onHide={handleClose} size="lg" className='contest-modal-sub' aria-labelledby="contained-modal-title-vcenter" centered>
        ...
        <ul className='reset' id="style-scrll">
                <li><b> चालू महिन्यात सुरु झालेल्या ट्रेडिंग खातेच ऑफरसाठी ग्राह्य धरले जातील.</b></li>
                        <li><b> गुंतवणुकीची रक्कम भरण्यासाठी, आणि नवीन ट्रेड/एसआयपी सुरु करण्यासाठी पुढील महिन्याच्या ६ तारखेपर्यंत मुदत वाढवून दिली जाईल.</b></li>
                        <li>योजनेच्या कालावधीत जमा झालेली रक्कम मार्जिन प्रोत्साहन गणनेसाठी विचारात घेतली जाईल.</li>
                        <li><b>पुढील महिन्याच्या ६ तारखेपर्यंत सुरु केलेल्या खात्यांचे एकूण मार्जिक/ एसआयपी अंतिम पेआऊटसाठी विचारात घेतले जाईल.</b></li>
                        ...
                        <li><b> मासिक पेआऊट पुढील महिन्याच्या २५ तारखेलाच प्रसिद्ध केले जाईल.</b></li>
