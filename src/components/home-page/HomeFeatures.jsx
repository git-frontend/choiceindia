                            ...
                            <div className="col-md-12">
                                <div className="all-features-list">
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub14} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
                                    ...
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub15} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
                                    ...
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub16} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
                                        {/* <img src={ImageSub16} className="img-fluid" alt='Loading' /> */}
                                        <h4>Robo Planner</h4>
                                        <p>An automated financial planner to handle your financial needs.</p>
                                    </div>
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub17} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
                                    ...
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub18} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
                                        {/* <img src={ImageSub18} className="img-fluid" alt='Loading' /> */}
                                        <h4>Swift Loans</h4>
                                        <p>Get hassle-free instant loans with minimum documentations</p>
                                    </div>
                                    <div className="feature-item">
                                        <LazyLoader src={ImageSub19} threshold={[0, 0.5, 1]} className="img-fluid" alt="Loading" />
